 ...
 * author:Mr.Chung
 * version:2.0
 * description:layuimini メニューフレームワーク拡張
 */
define(["jquery"], function ($) {
    ...
    var miniMenu = {
        ...
        /**
         * メニュー初期化
         * @param options.menuList   メニューデータ
        ...
        /**
         * シングルモジュール
         * @param menuList メニューデータ
         * @param menuChildOpen デフォルト展開
         */
        renderSingleModule: function (menuList, menuChildOpen) {
            ...
            $('.layui-layout-body').addClass('layuimini-single-module'); //シングルモジュール識別
        ...
        renderLeftMenu :function(leftMenus,options){
            options = options || {};
            var me = this ;
            var leftMenusHtml =  me.each(leftMenus || [],function (idx,leftMenu) { // 左側メニュー走査
        ...
        renderMultiModule: function (menuList, menuChildOpen) {
            ...
            if (menuChildOpen) childOpenClass = ' layui-nav-itemed';
            var headerMenuHtml = this.each(menuList, function (index, val) { //トップメニューレンダリング
            ...
            $('.layui-layout-body').addClass('layuimini-multi-module'); //マルチモジュール識別
            $('.layuimini-menu-header-pc').html(headerMenuHtml); //PC
            $('.layuimini-menu-left').html(leftMenuHtml);
            $('.layuimini-menu-header-mobile').html(headerMobileMenuHtml); //スマホ
            element.init();
        },
