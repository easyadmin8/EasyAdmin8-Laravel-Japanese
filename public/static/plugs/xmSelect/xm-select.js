 ...
 * @Title: xm-select
 * @Version: 1.2.4
 * @Description：layuiベースの複数選択ソリューション
...
!function (e) {
    ...
    1: function (e, t, n) {
        ...
        var Fe = function (e) {
            ...
            }(x), Ue = {tips: "選択してください", empty: "データがありません", searchTips: "検索してください", toolbar: {ALL: "全選択", CLEAR: "クリア", REVERSE: "反転選択", SEARCH: "検索"}, paging: {prev: "前へ", next: "次へ"}},
            ...
            return t = e, (n = [{
                                ...
                                label: {
                                    type: "block", text: {left: "", right: "", separator: ", "}, block: {showCount: 0, showIcon: !0, template: null}, count: {
                                        template: function (e, t) {
                                            return "選択済み ".concat(t.length, " 件、全 ").concat(e.length, " 件")
                                        }
                                    }
                ...
                key: "update", value: function () {
                    ...
                    if (n) {
                        ...
                        Object(c.k)("dataデータは配列型である必要があります。".concat("undefined" == typeof data ? "undefined" : Ye(data), "型は使用できません"))
                    } else Object(c.k)("レンダリング対象が見つかりません: ".concat(e.el, ", 確認してください"))
                }
            }, {
