    ...
    <div class="right">
        <div class="form-box">
            <div class="header">
                ...
                <p class="demo @if(!$isDemo)layui-hide @endif">ユーザー名:admin パスワード:123456</p>
            </div>
            <form id="loginForm" class="layui-form">
                <div class="field item">
                    <label for="username">アカウント</label>
                    <input lay-verify="required" class="layui-input" id="username" name="username" type="text" placeholder="アカウントを入力してください" autocomplete="off" maxlength="24"/>
                </div>
                <div class="field item">
                    <label for="password">パスワード</label>
                    <div class="input-wrap">
                        <input lay-verify="required" class="layui-input" id="password" type="password" name="password" autocomplete="off" maxlength="20" placeholder="パスワードを入力してください"/>
                ...
                <div class="field item layui-hide" id="gaCode">
                    <label for="gaCode">Google認証コード</label>
                    <input type="text" class="layui-input" name="ga_code" placeholder="Google認証コード" maxlength="6">
                </div>

                @if($captcha == 1)
                <div id="validatePanel" class="field item">
                    <label for="validatePanel">認証コード</label>
                    <div class="row">
                        <div class="layui-col-xs6">
                            <input type="text" class="layui-input" name="captcha" placeholder="認証コードを入力してください" maxlength="4">
                        </div>
                        <div class="layui-col-xs6">
                ...
                <div class="row">
                    <label class="remember"><input type="checkbox" class="icon-nocheck"/>ログイン状態を保持</label><a href="#">パスワードをお忘れですか？</a>
                </div>
