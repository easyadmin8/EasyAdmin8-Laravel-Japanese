...
<div class="layuimini-container">
    <form id="app-form" class="layui-form layuimini-form">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label required">権限名</label>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label required">ノード割り当て</label>
            <div class="layui-input-block">
        ...
        <div class="layui-form-item text-center">
            <button type="submit" class="layui-btn layui-btn-normal layui-btn-sm" lay-submit="system/auth/saveAuthorize">確認</button>
