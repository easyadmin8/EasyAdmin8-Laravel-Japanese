    ...
    <form id="app-form" class="layui-form layuimini-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="title" class="layui-input" lay-verify="required" lay-reqtext="クイック名を入力してください" placeholder="クイック名を入力してください" value="{{$row['title']}}">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="href" name="href" class="layui-input" lay-verify="required" placeholder="クイックリンクを入力してください" value="{{$row['href']}}">
            </div>
        </div>
