    ...
    <form id="app-form" class="layui-form layuimini-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="title" class="layui-input" lay-verify="required" placeholder="カテゴリ名を入力してください" value="">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block layuimini-upload">
                <input name="image" class="layui-input layui-col-xs6" lay-verify="required" placeholder="カテゴリ画像をアップロードしてください" value="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="sort" class="layui-input" placeholder="並び順を入力してください" value="0">
            </div>
        </div>
