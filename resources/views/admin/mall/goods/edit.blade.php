            ...
            <div class="layui-col-xl5 layui-col-lg5 layui-col-md12 layui-col-sm12 layui-col-xs12">
                        ...
                        <div class="layui-col-xs10">
                            ...
                            <div class="layui-input-block layui-col-space5">
                                <div class="layui-input-wrap">
                                    <input type="text" name="title" class="layui-input" lay-verify="required" placeholder="商品タイトルを入力してください" value="{{$row['title']}}">
                                </div>
                            </div>
                        </div>
                        <div class="layui-col-xs2">
                            <button class="layui-btn layui-bg-purple layui-btn-fluid" type="button" lay-on="AiOptimization">AI最適化</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layuimini-upload">
                        <input name="logo" class="layui-input layui-col-xs6" lay-verify="required" placeholder="商品画像をアップロードしてください" value="{{$row['logo']}}">
                        <div class="layuimini-upload-btn">
                            <span><a class="layui-btn" data-upload="logo" data-upload-number="one" data-upload-exts="png|jpg|ico|jpeg" data-upload-icon="image"><i class="fa fa-upload"></i> アップロード</a></span>
                            <span><a class="layui-btn layui-btn-normal" id="select_logo" data-upload-select="logo" data-upload-number="one" data-upload-mimetype="image/*"><i class="fa fa-list"></i> 選択</a></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layuimini-upload">
                        <input name="images" class="layui-input layui-col-xs6" lay-verify="required" placeholder="商品画像をアップロードしてください" value="{{$row['images']}}">
                        <div class="layuimini-upload-btn">
                            <span><a class="layui-btn" data-upload="images" data-upload-number="more" data-upload-exts="png|jpg|ico|jpeg" data-upload-icon="image"><i class="fa fa-upload"></i> アップロード</a></span>
                            <span><a class="layui-btn layui-btn-normal" id="select_images" data-upload-select="images" data-upload-number="more" data-upload-mimetype="image/*"><i class="fa fa-list"></i> 選択</a></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="market_price" class="layui-input" lay-verify="required" placeholder="市場価格を入力してください" value="{{$row['market_price']}}">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="discount_price" class="layui-input" lay-verify="required" placeholder="割引価格を入力してください" value="{{$row['discount_price']}}">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="virtual_sales" class="layui-input" lay-verify="required" placeholder="仮想販売数を入力してください" value="{{$row['virtual_sales']}}">
                    </div>
                </div>
